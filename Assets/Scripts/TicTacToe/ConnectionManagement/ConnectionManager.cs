...
using TicTacToe.ConnectionManagement.ConnectionState;
using Unity.Netcode;
using UnityEngine;
using VContainer;

namespace TicTacToe.ConnectionManagement
{
    ...
    public class ConnectionManager : MonoBehaviour
    {
        ...
        void Start()
        {
            List<ConnectionState.ConnectionState> states = new() { m_Offline, m_ClientConnecting, m_ClientConnected, m_ClientReconnecting, m_StartingHost, m_Hosting };
